 ...
 */
final class Version20250418083836 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE chats (id INT AUTO_INCREMENT NOT NULL, user1_id INT NOT NULL, user2_id INT NOT NULL, fixed TINYINT(1) NOT NULL, INDEX IDX_2D68180F56AE248B (user1_id), INDEX IDX_2D68180F441B8B65 (user2_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE dislikes (id INT AUTO_INCREMENT NOT NULL, disliker_id INT NOT NULL, disliked_id INT NOT NULL, disliked_at DATETIME NOT NULL, INDEX IDX_2DF3BE119DEB4BAF (disliker_id), INDEX IDX_2DF3BE11E89943EC (disliked_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE dislikes ADD CONSTRAINT FK_2DF3BE119DEB4BAF FOREIGN KEY (disliker_id) REFERENCES users (id)');
        $this->addSql('ALTER TABLE dislikes ADD CONSTRAINT FK_2DF3BE11E89943EC FOREIGN KEY (disliked_id) REFERENCES users (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dislikes DROP FOREIGN KEY FK_2DF3BE119DEB4BAF');
        $this->addSql('ALTER TABLE dislikes DROP FOREIGN KEY FK_2DF3BE11E89943EC');
